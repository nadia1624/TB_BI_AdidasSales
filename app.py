...
def main():
    ...
    with col1:
        ...
        create_kpi_card(
            "Total Penjualan",
            f"Rp {kpis['total_sales']:,.1f} M",
            f"▲ 12% dibanding tahun lalu",
            sales_alert
        )
    ...
    with col2:
        ...
        create_kpi_card(
            "Total Keuntungan",
            f"Rp {kpis['total_profit']:,.1f} M",
            f"▲ 15% dibanding tahun lalu",
            profit_alert
        )
    ...
    with col3:
        create_kpi_card(
            ...
            f"▲ 7% dibanding tahun lalu"
        )
    
    with col4:
        create_kpi_card(
            "Harga Rata-rata per Unit",
            f"Rp {kpis['avg_price']:,.0f}",
            f"▲ 4% dibanding tahun lalu"
        )
